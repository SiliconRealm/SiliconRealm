...
Queen 是整个 Silicon Realm 的 **核心编排引擎**，是王国真正的"心脏"和"神经中枢"。
...
Lord 是一个 **常驻的 OpenClaw 容器**，采用双层会话模型实现"常驻响应 + 任务隔离"。
...
| 同构架构 | King 与 Lord 同构，统一技术栈，代码复用，灵活扩展 |
| DDD 领域分层 | King 是核心领域，Lord 是业务领域，职责清晰 |
| 双层会话模型 | 守护会话常驻响应 + Topic 会话任务隔离 |
| Knight 沙箱 | King/Lord 都可派发，安全隔离，用完即毁 |
| 王室双星 | King 负责战略，Queen 负责执行，职责分明 |
| 圆桌会议 | 解决 AI 协作无序问题 |
